...
public class WorkTableBlock extends BlockBase implements ITileEntityProvider,IHasModel
{

	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	public static final PropertyBool WORKING = PropertyBool.create("working");
	
	public WorkTableBlock(String name) 
	{
	...
	{
		return Item.getItemFromBlock(BlockInit.WORK_TABLE);
	}
	
	@Override
	public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
	{
		return new ItemStack(BlockInit.WORK_TABLE);
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos) 
	{
		...
		if(active) worldIn.setBlockState(pos, BlockInit.WORK_TABLE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(WORKING, true), 3);
		else worldIn.setBlockState(pos, BlockInit.WORK_TABLE.getDefaultState().withProperty(FACING, state.getValue(FACING)).withProperty(WORKING, false), 3);

...
public class ContainerWorkTable extends Container
{
	...
	public ContainerWorkTable(InventoryPlayer player, TileEntityWorkTable tileentity) 
	{
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
		...
		if(slot != null && slot.getHasStack()) 
		{
			...
			{		
				...
				if(!WorkTableRecipes.getInstance().getSinteringResult(stack1, slot1.getStack()).isEmpty())
				{
					if(!this.mergeItemStack(stack1, 0, 2, false)) 
					{
						return ItemStack.EMPTY;
					}
					else if(TileEntityWorkTable.isItemFuel(stack1))
					{
